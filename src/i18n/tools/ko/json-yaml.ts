export default {
  ...
  ui: {
    clear: '초기화',
    sampleData: '샘플 데이터',
    useOutputAsInput: '결과를 입력으로',
    input: '입력',
    result: '결과',
    copy: '복사하기',
    copied: '복사됨',
    jsonInputPlaceholder: 'JSON 데이터를 입력하세요...',
    yamlInputPlaceholder: 'YAML 데이터를 입력하세요...',
    jsonOutputPlaceholder: '변환된 JSON이 여기에 표시됩니다.',
    yamlOutputPlaceholder: '변환된 YAML이 여기에 표시됩니다.',
    invalidJson: '유효하지 않은 JSON',
    invalidYaml: '유효하지 않은 YAML',
