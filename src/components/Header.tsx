...
import { getLocaleFromPathname, getPathWithLocale, defaultLocale } from '@/i18n/config';
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-[var(--color-bg)]/80 backdrop-blur-xl">
      <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
        {/* Logo */}
        <Link href={toolHref('/')} className="flex items-center gap-2.5 group">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label={dict.header.themeToggle}
          >
            {theme === 'dark' ? (
